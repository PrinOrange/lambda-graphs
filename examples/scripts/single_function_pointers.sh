...
# examples/single/function_pointers.cpp.
# Each view is generated separately and its output files are renamed to
# include the view name, e.g. function_pointers.json ->
# function_pointers_cfg.json, before the next view is generated.
#
set -euo pipefail
...
SRC_LANG="cpp"
CODE_FILE="./examples/single/function_pointers.cpp"
BASE="function_pointers"   # lambda-graphs names outputs after the file stem
