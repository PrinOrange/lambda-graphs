#!/usr/bin/env bash
#
# Generate CFG, DFG and AST (json + dot + png) for examples/single/demo.cpp.
# Each view is generated separately and its output files are renamed to
# include the view name, e.g. demo.json -> demo_cfg.json, before the next
# view is generated.
#
set -euo pipefail
...
SRC_LANG="cpp"
CODE_FILE="./examples/single/demo.cpp"
BASE="demo"   # lambda-graphs names outputs after the file stem
